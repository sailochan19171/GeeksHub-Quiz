! function (t) {
    ...
    for (var r = n(29), o = n(30), i = n(12), c = n(1), s = n(9), a = n(28), u = n(3), f = u("iterator"), l = u("toStringTag"), p = a.Array, h = {
            CSSRuleList: !0,
    ...
    var r = n(5),
        ...
        a = function () {
            var t, e = n(35)("iframe"),
                r = i.length;
            for (e.style.display = "none", n(61).appendChild(e), e.src = "javascript:", (t = e.contentWindow.document).open(), t.write("<script>document.F=Object<\/script>"), t.close(), a = t.F; r--;) delete a.prototype[i[r]];
            return a()
        };
    ...
    C || (O = function (t) {
        ...
        Promise: O
    }), n(36)(O, "Promise"), n(78)("Promise"), c = n(15).Promise, l(l.S + l.F * !C, "Promise", {
        reject: function (t) {
            var e = L(this);
    ...
    "use strict";
    n.r(e);
    n(212), n(213), n(214), n(215), n(216), n(217), n(218), n(219), n(220), n(221), n(222), n(223)
}, function (t, e) {
    ! function () {
        "use strict";
    ...
    domFactory.handler.register("text-scramble", function () {
        var t, e = ["to Code", "to Think", "to Design", "to Build" ,"to Work"];
        return {
